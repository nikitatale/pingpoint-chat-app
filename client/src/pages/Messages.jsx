    ...
    <div className='min-h-screen relative bg-slate-50'>
      <div className='max-w-6xl mx-auto p-6'>
        <div className='mb-8'>
           ...
           <p className='text-slate-600'>Stay in touch with your world, one message at a time.</p>
        </div>
           ...
           <div className='flex flex-col gap-3'>
            {
              connections.map((user) => (
                <div key={user._id} className='max-w-xl flex flex-warp gap-5 p-6 bg-white shadow rounded-md'> 
                  <img src={user.profile__picture} className='rounded-full size-12 mx-auto' alt='image'/>
